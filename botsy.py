...
[SVG]
 — 6:11 PM
wait
in 1-2 minutes it will be ready
᲼
[SVG]
 — 6:12 PM
Image
...
[SVG]
 — 6:12 PM
if i want to update the code
i just update in github
and it will auto update here?
or do i need to redo this
Giannis
[SVG]
 — 6:13 PM
yes it auto updates but you need to check the new events
you need to go to events and it will say something like auto deploy
Image
is it ready?
᲼
[SVG]
...
[SVG]
 — 6:15 PM
https://botty-fegu.onrender.com/
Giannis
[SVG]
 — 6:15 PM
now
go to uptimerobot and create an account
then add monitor and add this link and make it monitor it every 5minutes
once this done it will stay online 24/7
᲼
[SVG]
 — 6:17 PM
all done
...
nice
well done
if you want to change the code dont remove the flask
it wont work
᲼
[SVG]
 — 6:18 PM
alr so now
if i update code on github
i just restart
this?
Image
Giannis
...
[SVG]
 — 6:18 PM
in the events you will see something like auto upload
Giannis
[SVG]
 — 6:18 PM
no only if there is a bug
like this
Image
᲼
[SVG]
...
[SVG]
 — 6:19 PM
and if you press in the word Deploy it will take you to the logs
᲼
[SVG]
 — 6:21 PM
will this code work
...
message.txt
25 KB
just in requirements also add aiohttp
under flask
﻿
import discord
from discord.ext import commands
...
async def withdraw(ctx, amount):
    ...
    if amount <= 0 or economy[user_id]['bank'] < amount:
        embed = discord.Embed(title="🏦 Bank", description="Invalid withdrawal amount!",
